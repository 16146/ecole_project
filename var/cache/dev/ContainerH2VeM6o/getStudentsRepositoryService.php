...
// Returns the private 'App\Repository\StudentsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StudentsRepository.php';

return $this->privates['App\\Repository\\StudentsRepository'] = new \App\Repository\StudentsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
