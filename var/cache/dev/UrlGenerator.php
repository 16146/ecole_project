...
return [
    ...
    'api_editClass' => [['id'], ['_controller' => 'App\\Controller\\ApiController::APIaddClass'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/api/classes']], [], []],
    ...
    'api_editStudent' => [['id'], ['_controller' => 'App\\Controller\\ApiController::APIaddStudent'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/api/students']], [], []],
    ...
    'editClass' => [['id'], ['_controller' => 'App\\Controller\\EcoleHomeController::newClass'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/home/editClass']], [], []],
    'newStudent' => [['id1'], ['id1' => null, '_controller' => 'App\\Controller\\EcoleHomeController::newStudent'], [], [['text', '/students/new_student/'], ['variable', '/', '[^/]++', 'id1', true], ['text', '/home/classes']], [], []],
