...
include_once $this->targetDirs[3].'\\src\\DataFixtures\\ClassFixtures.php';
include_once $this->targetDirs[3].'\\src\\DataFixtures\\StudentsFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ClassFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\StudentsFixtures(), 'groups' => []]]);
