...
class __TwigTemplate_12caa6d5e45ce849ec7b8d6834972bb8f3da8e71d28d44f4242f9b58d13afcd1 extends \Twig\Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        ";
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["liste_students"]) || array_key_exists("liste_students", $context) ? $context["liste_students"] : (function () { throw new RuntimeError('Variable "liste_students" does not exist.', 7, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["students"]) {
                // line 8
                echo "        <br>
            <p><strong>";
                // line 9
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["students"], "nameclass", [], "any", false, false, false, 9), "html", null, true);
                echo "</strong> :";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["students"], "studentfirstname", [], "any", false, false, false, 9), "html", null, true);
                echo " </p>
        <br>
        ";
            }
...
";
    ...
    {
        return array (  118 => 15,  114 => 13,  111 => 12,  100 => 9,  97 => 8,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    {% if app.user %} 
        ...
        <br>
            <p><strong>{{ students.nameclass }}</strong> :{{ students.studentfirstname }} </p>
        <br>
        {% endfor %}
    {% else %}
