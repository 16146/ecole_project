...
// Returns the private 'App\Repository\IdentificationsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\IdentificationsRepository.php';

return $this->privates['App\\Repository\\IdentificationsRepository'] = new \App\Repository\IdentificationsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
