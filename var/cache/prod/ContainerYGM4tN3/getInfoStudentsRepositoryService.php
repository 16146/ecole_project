...
// Returns the private 'App\Repository\InfoStudentsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\InfoStudentsRepository.php';

return $this->privates['App\\Repository\\InfoStudentsRepository'] = new \App\Repository\InfoStudentsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
